...
class TestInvididual(unittest.TestCase):
    ...
    def test_json_to_csv(self):
        set_run_info(import_json_path='json/test.json', export_csv_path='csv/schedule.csv')
        Exchanger.json_to_csv(config['import_json_path'], config['export_csv_path'])
